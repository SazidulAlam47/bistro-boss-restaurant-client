...
const Header = () => {
    ...
    return (
        <div className="bg-[#15151580] text-white fixed z-20 w-full">
            <div className="container mx-auto px-3 md:px-6 navbar">
                <div className="w-1/2 lg:w-[30%] justify-start">
                    ...
                    <Link to="/" className="flex flex-col font-cinzel text-xl">
                ...
                <div className="w-1/2 lg:w-[70%] justify-end">
                    <nav className="hidden lg:flex gap-3 px-1">{navLinks}</nav>
