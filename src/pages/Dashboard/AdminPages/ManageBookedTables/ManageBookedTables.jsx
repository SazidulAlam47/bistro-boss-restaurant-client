...
const ManageBookedTables = () => {
    const axiosSecure = useAxiosSecure();

    const { data: reservations = [], isPending } = useQuery({
        queryKey: ["manage-booked-tables"],
        queryFn: async () => {
    ...
    if (isPending) {
        return (
            <>
                <Helmet>
                    <title>Bistro Boss | Manage Booked Tables</title>
                </Helmet>
                <SectionTitle
                    subHeading="All reservations"
                    heading="Manage Booked Tables"
                />
...
export default ManageBookedTables;
